...
Linux usa como una base para organizar los diferentes sistemas de archivos un sistema de archivos virtual~\cite{vfs:website} donde se montan cada uno de los diferentes sistemas de archivos del sistema operativo. Este sistema de archivos virtual no contiene archivos ni directorios pero mantiene información acerca de que sistemas de archivos están montados. El sistema de archivos root (montado en \path{/}) es sobre el que se manejara el sistema de archivos virtual.
