...
Este organizador presenta todos los archivos encontrados en un solo directorio. La implementación se encuentra en el archivo \path{dejumblefs/organizers/flat.py}~(\ref{dejumblefs/organizers/flat.py}) y se llama \textit{FlatOrganizer}. Este organizador atraviesa todo el sistema de archivos original desde la raiz definida por el parametro \textit{root} al momento de montar y extrae solamente el nombre de los archivos encontrados descartando la parte del directorio donde se encontraban.
