...
Estas funciones modifican solamente las propiedades del archivo. La única excepción es  \textit{truncate} que sí cambia al archivo. Este método requiere a nivel de FUSE para poder cortar un archivo sin abrirlo. Todas estas funciones se envían directamente al cache sin pasar por el organizador.
